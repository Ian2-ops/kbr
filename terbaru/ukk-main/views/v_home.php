...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h3>Selamat Datang <?= $nama ?> di Peduli Diri</h3>
            </div>
        </div>
        <!-- total data catatan  -->
        <div class="row mt-5">
            <div class="col-lg-4">
                <div class="card bg-bluish text-white shadow-md" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Catatan Tersimpan</h5>
                        <div class="card-text">
                            <?php
                            echo $count;
                            ?>
                ...
                <div class="card">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-black">Catatan Perjalanan Anda</h6>
